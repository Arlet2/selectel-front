  ...
  return (<>
    ...
    <div className={styles.container}>
        <div className={styles.textContainer}>
            ...
            <p className={styles.textDefault}>
            Данная платформа является мостом между владельцами питомцев, которым требуется помощь, и добровольцами, готовыми поделиться жизненно важным ресурсом своих любимцев</p>
